...
require (
	github.com/ebitengine/purego v0.11.0-alpha.8.0.20260812182835-f9d41fc60f1f
...
require (
	...
	github.com/ebitengine/oto/v3 v3.5.0-alpha.9.0.20260813040608-322dd9572366 // indirect
