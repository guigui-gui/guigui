...
require (
	github.com/ebitengine/purego v0.11.0-alpha.3.0.20260604015905-d339eb0fd4d3
	...
	github.com/hajimehoshi/ebiten/v2 v2.10.0-alpha.11.0.20260604050435-bccc04ba63d9
