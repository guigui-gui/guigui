...
type SliderEventArgsValueChanged struct {
	Value     int
	Committed bool
}

type SliderEventArgsValueChangedBigInt struct {
	Value     *big.Int
	Committed bool
}

type SliderEventArgsValueChangedInt64 struct {
	Value     int64
	Committed bool
}

type SliderEventArgsValueChangedUint64 struct {
	Value     uint64
	Committed bool
}
