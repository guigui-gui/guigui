...
func appendRecommendedFaceSourceEntries(context *guigui.Context, adder *basicwidget.FaceSourceEntryAdder) {
...
func init() {
	basicwidget.RegisterFaceSourceEntries(appendRecommendedFaceSourceEntries)
}
