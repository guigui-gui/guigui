...
func lineHeightModeSuffix(lineHeightMode textutil.LineHeightMode) string {
	switch lineHeightMode {
	case textutil.LineHeightModeFixed:
		return "/fixedLineHeight"
	case textutil.LineHeightModeFlexible:
		return "/flexibleLineHeight"
	}
	return ""
}
