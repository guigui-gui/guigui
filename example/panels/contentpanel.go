...
func (c *ContentPanel) Build(context *guigui.Context, adder *guigui.WidgetAdder) error {
...
func (c *contentPanelContent) Build(context *guigui.Context, adder *guigui.WidgetAdder) error {
