...
func (t *TextInputs) Build(context *guigui.Context, adder *guigui.WidgetAdder) error {
...
func (c *inlineTextInputContainer) Build(context *guigui.Context, adder *guigui.WidgetAdder) error {
