...
func (l *Lists) Build(context *guigui.Context, adder *guigui.ChildAdder) error {
	...
	list.SetOnItemsMoved(func(context *guigui.Context, widgetBounds *guigui.WidgetBounds, from, count, to int) {
	...
	tree.SetOnItemExpanderToggled(func(context *guigui.Context, widgetBounds *guigui.WidgetBounds, index int, expanded bool) {
	...
	l.jumpButton.SetOnDown(func(context *guigui.Context, widgetBounds *guigui.WidgetBounds) {
	...
	l.showStripeToggle.SetOnValueChanged(func(context *guigui.Context, widgetBounds *guigui.WidgetBounds, value bool) {
	...
	l.showHeaderToggle.SetOnValueChanged(func(context *guigui.Context, widgetBounds *guigui.WidgetBounds, value bool) {
	...
	l.showFooterToggle.SetOnValueChanged(func(context *guigui.Context, widgetBounds *guigui.WidgetBounds, value bool) {
	...
	l.movableToggle.SetOnValueChanged(func(context *guigui.Context, widgetBounds *guigui.WidgetBounds, value bool) {
		model.Lists().SetMovable(value)
	})
	l.enabledText.SetValue("Enabled")
	l.enabledToggle.SetOnValueChanged(func(context *guigui.Context, widgetBounds *guigui.WidgetBounds, value bool) {
