...
func (n *NumberInputs) Build(context *guigui.Context, adder *guigui.ChildAdder) error {
	...
	model := context.Env(n, modelKeyModel).(*Model)
	...
	n.numberInput1.Widget().OnValueChangedBigInt(func(context *guigui.Context, value *big.Int, committed bool) {
		if !committed {
			return
		}
	...
	n.numberInput2.Widget().OnValueChangedUint64(func(context *guigui.Context, value uint64, committed bool) {
		if !committed {
			return
		}
	...
	n.numberInput3.Widget().OnValueChangedInt64(func(context *guigui.Context, value int64, committed bool) {
		if !committed {
			return
		}
	...
	n.enabledToggle.OnValueChanged(func(context *guigui.Context, value bool) {
